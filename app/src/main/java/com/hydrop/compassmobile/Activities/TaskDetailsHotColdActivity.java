...
import com.hydrop.compassmobile.Activities.Adapters.TaskDetailsHotColdAdapter;
 ...
 */
public class TaskDetailsHotColdActivity extends TaskDetailsActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case bluetherm_ProbeButtonPressed:
                    ...
                    ((TaskDetailsHotColdAdapter) mAdapter).resetFocus();
                    break;
    ...
    protected void initAdapter() {
        ...
        mAdapter = new TaskDetailsHotColdAdapter(modifiedResultList, realm, this, asset.getHotType(), asset.getColdType());
    ...
    private void updateFields(String value){
        ...
        for (int i = 0; i < children;i++){
            ...
            if (taskTemplateParameter.getParameterName().equals("TemperatureHot") ||
                ...
                ((TaskDetailsHotColdAdapter) mAdapter).update(value);
            }
