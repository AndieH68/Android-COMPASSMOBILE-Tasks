...
//        }
    ...
    private void navigateToTaskDetails(String taskId){
        ...
        if (taskName.equals("Remedial Task")){
            Toast.makeText(this,getString(R.string.remedial_tasks_not_supported),Toast.LENGTH_SHORT).show();
            return;
        }
        Intent intent = new Intent(TaskActivity.this,TaskDetailsActivity.class);
        if ((ppmGroup.equals("DistributionServices") || ppmGroup.equals("SentinelOutlets"))
                && taskName.equals("TemperatureMonitoring")) {
            intent = new Intent(TaskActivity.this,TaskDetailsHotColdActivity.class);
