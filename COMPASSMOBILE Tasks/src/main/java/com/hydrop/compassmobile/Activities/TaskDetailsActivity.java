...
public class TaskDetailsActivity extends AppCompatActivity {
    ...
    protected Task task;
    protected TextView ppmGroupTextView,taskNameTextView,locationValueTextView,taskRefValueTextView,assetNumberValueTextView;
    ...
    protected TaskDetailsItem addChild(TaskTemplateParameter childParameter){
    ...
    protected TaskDetailsItem findParentForId(String parentId){
